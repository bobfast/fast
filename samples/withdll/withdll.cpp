...
int CDECL main(int argc, char **argv)
{
    ...
    */
    ...
    //     printf("withdll.exe: DetourUpdateProcessWithDll failed: %ld\n", GetLastError());
    //     return FALSE;
    // }

    //WriteProcessMemory(hProcess, pRemoteBuf, (LPVOID)sz, dwBufSize, NULL);
